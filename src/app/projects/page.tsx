  ...
  return (
    <div className="min-h-screen bg-[#F7F2EC]">
      <div className="p-20 flex flex-col items-center justify-center gap-10">
        <p className="text-center font-semibold text-4xl text-[#6F4E37] my-3 mt-10">
          Some things I've built and designed.
        </p>
        <div className="flex flex-col items-center justify-center gap-8">
          <p className="text-center font-semibold text-2xl text-[#6F4E37] my-3">
            Web Development
          </p>
          <div>
            <div className="flex items-center gap-8 justify-center w-250 p-8 rounded-lg bg-[#6F4E37]">
          ...
          <div>
            <div className="flex items-center gap-8 justify-center w-250 p-8 rounded-lg bg-[#6F4E37]">
              <div className="flex flex-col items-end text-end">
                <p className="text-lg font-semibold">Managemen Siswa</p>
                <p>
          ...
          <div>
            <div className="flex items-center gap-8 justify-center w-250 p-8 rounded-lg bg-[#6F4E37]">
              ...
              <div>
                <p className="text-lg font-semibold">SIPESS</p>
                <p>
        ...
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <div>
            <div className="flex items-center gap-8 justify-center w-250 p-8 rounded-lg bg-[#6F4E37]">
              ...
              <div>
                <p className="text-lg font-semibold">Frezzz News</p>
                <p>
